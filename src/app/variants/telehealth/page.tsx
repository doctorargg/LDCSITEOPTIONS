...
import { FiVideo, FiMonitor, FiSmartphone, FiWifi, FiLock, FiCalendar, FiClock, FiHeadphones, FiMessageSquare, FiShare2, FiDownload, FiCheckCircle, FiHeart, FiUsers } from 'react-icons/fi';
